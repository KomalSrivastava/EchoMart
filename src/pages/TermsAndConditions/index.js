...
const TermsAndConditions = () => {
  ...
  return (
    <div className="terms-and-conditions-container">
      ...
      <p>
        Welcome to EchoCart. These terms and conditions outline the
        rules and regulations for the use of echocart & Grocery's Website.
      </p>
      ...
      <p>
        Other than the content you own, under these Terms, EchoMart & Grocery
      ...
      <p>
        ...
        display on this Website. By displaying Your Content, you grant EchoMart
        & Grocery a non-exclusive, worldwide irrevocable, sub licensable license
      ...
      <p>
        This Website is provided "as is," with all faults, and EchoMart &
        Grocery express no representations or warranties, of any kind related to
      ...
      <p>
        In no event shall EchoMart & Grocery, nor any of its officers,
        ...
        liability is under contract. Nest Mart & Grocery, including its
      ...
      <p>
        You hereby indemnify to the fullest extent EchoMart & Grocery from and
      ...
      <p>
        Nest Mart & Grocery is permitted to revise these Terms at any time as it
      ...
      <h2>10. Assignment</h2>
      <p>
        The Nest Mart & Grocery is allowed to assign, transfer, and subcontract
      ...
      <p>
        These Terms constitute the entire agreement between Nest Mart & Grocery
      ...
      <p>
        ...
        laws of the State of Netherlands, and you submit to the non-exclusive
        jurisdiction of the state and federal courts located in Netherlands for
