...
const Footer = () => {
  ...
  const location = `Jaypee University of Engineering and Technology A-B Road, Raghogarh, Guna (M.P.) - 473226, INDIA`;
  const FooterData = [
    {
      title: 'Company',
      data: [
  ...
  const SocialMedia = [
    {
      link: ' https://www.linkedin.com/in/komal-a2392624a',
      icon: <LinkedinIcon />
    },
    { link: ' https://github.com/KomalSrivastava#', icon: <GitHubIcon /> },
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-md-3 part1">
                ...
                <h5
                  className="mail-tel"
                  onClick={() => (window.location = 'mailto:komalkashyap2107@gmail.com')}
                >
                  <EmailOutlinedIcon /> <strong> Email : </strong> mailto:komalkashyap2107@gmail.com
                </h5>
                <h5>
